...
if !hasmapto('<Plug>NormalTableMode0', 'n')
    nmap <silent> <Leader>t :.,'}call <Sid>TableInternal(0, 0)<cr>
endif
if !hasmapto('<Plug>VisualTableMode0', 'v')
    vmap <silent> <Leader>t "ty:call <Sid>TableInternal(0, 1)<cr>
endif

if !hasmapto('<Plug>NormalTableMode1', 'n')
    nmap <silent> <Leader>T :.,'}call <Sid>TableInternal(1, 0)<cr>
endif
if !hasmapto('<Plug>VisualTableMode1', 'v')
    vmap <silent> <Leader>T "ty:call <Sid>TableInternal(1, 1)<cr>
endif
